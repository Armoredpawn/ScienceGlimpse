      ...
      <main className="relative z-10 pt-20">
        ...
        <section className="py-16 px-4 bg-muted/20">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card/60 backdrop-blur-sm border border-border rounded-xl p-8">
              ...
              <p className="text-2xl text-foreground leading-relaxed text-center font-semibold">
                Our mission is to educate and inspire by making science{' '}
                <span className="text-quantum">accessible</span>,{' '}
                <span className="text-neuron">engaging</span>, and{' '}
                <span className="text-cosmic">relevant to everyday life</span>.
                We explore a wide range of scientific topics to spark curiosity
                and <span className="text-neuron">empower the next generation</span>{' '}
                of thinkers, innovators, and world-changers.
                <br />
                <br />
                Through{' '}
                <span className="text-cosmic">
                  creative storytelling and interactive learning
                </span>
                , we believe that understanding how the world around us works is
                key to{' '}
                <span className="text-neuron">shaping a better future</span> for
                everyone.
              </p>
            </div>
          </div>
        ...
        <footer className="py-16 px-4 border-t border-border bg-card/30 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto text-center">
            <p className="text-muted-foreground">
              © 2025 ScienceGlimpse. Made with curiosity by students, for
              students.
            </p>
