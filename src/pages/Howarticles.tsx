        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-quantum via-molecule to-neuron bg-clip-text text-transparent mb-4">
              {category ? `${categoryNames[category as keyof typeof categoryNames]} Articles` : 'How???'}
            </h1>
              ...
              >
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border">
                    ...
                    <Button size="sm" variant="outline" onClick={() => window.location.href = `#/junior?id=${article.id}`}>
                      Read More →
                    </Button>
                  </div>
                </div>
