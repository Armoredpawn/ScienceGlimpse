        ...
        <div className="pt-8 flex flex-col items-center gap-4 w-full max-w-xl mx-auto">
          <div className="flex flex-row w-full gap-4">
            <Button
              ...
              className="bg-purple-600 hover:bg-purple-700 text-white text-lg flex-1 py-4"
            >
              Submit Your Article →
            </Button>
            <Button
          ...
          <Button
            ...
            className="w-full bg-green-600 text-white text-lg py-6 shadow-md hover:shadow-lg transition-shadow duration-200"
          >
            Themes
          </Button>
        </div>
